...
const char HTTP_FORM_WIFI[]        PROGMEM = "<label for='s'>SSID</label><input id='s' name='s' maxlength='32' autocorrect='off' autocapitalize='none' placeholder='{v}'><br/><label for='p'>Password</label><input id='p' name='p' maxlength='64' type='password' placeholder='{p}'><br/><label for='e'>Email</label><br/><input id='e' name='e' length=32 placeholder='Email'><br/><label for='pf'>Password Firebase</label><input id='pf' name='pf' length=64 type='password' placeholder='password firebase'><br/>";
